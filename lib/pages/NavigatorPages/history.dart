...
import 'package:tagxi_super_user/pages/NavigatorPages/historydetails.dart';
                                                                          ...
                                                                          children: [
                                                                            SizedBox(
                                                                              ...
                                                                              child: Text(
                                                                                ...
                                                                                style: GoogleFonts.robotoCondensed(fontSize: media.width * eighteen, fontWeight: FontWeight.w600),
                                                                              ),
                                                                            ),
                                                                            SizedBox(
                                                                                  ...
                                                                                  (myHistory[i]['payment_opt'] == '1')
                                                                                      ...
                                                                                      : (myHistory[i]['payment_opt'] == '2')
                                                                                          ...
                                                                                          : (myHistory[i]['payment_opt'] == '0')
                                                                                              ...
                                                                                              : '',
                                                                                  style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve, fontWeight: FontWeight.w600),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                          ],
                                                                              ...
                                                                              Column(
                                                                                children: [
                                                                                  Text(
                                                                                    ...
                                                                                    style: GoogleFonts.robotoCondensed(fontSize: media.width * sixteen, fontWeight: FontWeight.bold),
                                                                                  ),
                                                                                  SizedBox(
                                                                                    height: media.width * 0.01,
                                                                                  ),
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              ...
                                                                              style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve, color: const Color(0xff898989)),
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                GoogleFonts.robotoCondensed(fontSize: media.width * sixteen, fontWeight: FontWeight.w600),
                                                                          ),
                                                                          Image
                                                                              .asset(
                                                                            (myHistory[i]['transport_type'] == 'taxi')
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                myHistory[i]['request_number'],
                                                                                style: GoogleFonts.robotoCondensed(fontSize: media.width * sixteen, fontWeight: FontWeight.w600),
                                                                              ),
                                                                              Image.asset(
