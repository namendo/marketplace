...
import 'package:tagxi_super_user/functions/geohash.dart';
import 'package:tagxi_super_user/pages/NavigatorPages/pickcontacts.dart';
import 'package:tagxi_super_user/pages/chatPage/chat_page.dart';
import 'package:tagxi_super_user/pages/onTripPage/choosegoods.dart';
import 'package:tagxi_super_user/pages/onTripPage/drop_loc_select.dart';
                                                                                                          ...
                                                                                                          children: [
                                                                                                            ...
                                                                                                            (minutes[etaDetails[i]['type_id']] != null && minutes[etaDetails[i]['type_id']] != '')
                                                                                                                ? Text(
                                                                                                                    ...
                                                                                                                    style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve, color: textColor.withOpacity(0.3)),
                                                                                                                  )
                                                                                                                : Text(
                                                                                                                    '- -',
                                                                                                                    style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve, color: textColor.withOpacity(0.3)),
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Row(
                                                                                                              children: [
                                                                                                                Text(
                                                                                                                  etaDetails[i]['name'],
                                                                                                                  style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve),
                                                                                                                ),
                                                                                                                SizedBox(
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            goodsTypeList.firstWhere((e) => e['id'] == int.parse(selectedGoodsId))['goods_type_name'] +
                                                                                ...
                                                                                ')',
                                                                            style:
                                                                                GoogleFonts.robotoCondensed(fontSize: media.width * twelve, color: buttonColor),
                                                                            maxLines:
                                                                                1,
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
                                                                                          ...
                                                                                          Column(
                                                                                            ...
                                                                                            children: [
                                                                                              Text(
                                                                                                ...
                                                                                                style: GoogleFonts.robotoCondensed(fontSize: media.width * fourteen, fontWeight: FontWeight.w600),
                                                                                              ),
                                                                                              Text(
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                GoogleFonts.robotoCondensed(fontSize: media.width * twelve, color: (chatList.where((element) => element['from_type'] == 2 && element['seen'] == 0).isEmpty) ? hintColor : const Color(0xffFF0000)),
                                                                          ),
                                                                        ),
                                                                        (chatList.where((element) => element['from_type'] == 2 && element['seen'] == 0).isEmpty)
                                                                            ? RotatedBox(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    ...
                                                                                    style: GoogleFonts.robotoCondensed(fontSize: media.width * twelve, fontWeight: FontWeight.bold),
                                                                                  ),
